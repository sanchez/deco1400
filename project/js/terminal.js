...
/**
 * Represents the entire sandbox repository which all the commands will have access to
 */
class Repo {
    constructor() {
        this.branches = {
...
/**
 * Git command to initialise the repository
 */
...
/**
 * Checks to see if the repo exists and if not throw an error
 */
...
/**
 * Git command to add a file/s to the staged area
 */
...
/**
 * Git command to reset the staged files
 */
...
/**
 * Git command to show the status of the repository
 */
...
/**
 * Git command to commit a file to the repository
 */
...
/**
 * Git command to show a list of previous commands
 */
...
/**
 * Git command to create a branch in the repository
 */
...
/**
 * Git command to move the active branch to the destination
 */
...
/**
 * Git command to merge a branch into the active branch
 */
...
/**
 * Maps the git argument to a supported command and returns the result
 * @param {string} command The git subcommand that was entered in
 * @param {string[]} args An array of extra arguments passed in
 * @param {Repo | undefined} repo The active repository used in the session
 */
...
/**
 * Accepts an input and returns the output of the requested command
 * @param {string} command The entire input received from the user
 * @param {Repo | undefined} repo The active repository of the session
 */
...
/**
 * The controller class for the input bar of the terminal
 */
class TerminalInput {
...
/**
 * The main controller class for the entire terminal sandbox
 */
class Terminal {
...
/**
 * Globally declared checkers used to verify the user's input
 */
const checkers = {
...
/**
 * Globally declared initiators which can help make a repository pre-filled for the test
 */
const initers = {
    "branch": function () {
        const r = gitInit();
...
/**
 * Called on the page load, loads all the terminals on the screen
 */
