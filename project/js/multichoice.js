/**
 * Reprsents a single option in the multichoice list
 */
...
/**
 * Represents a set of options which the user will pick from for an answer
 */
class MultiChoice {
...
/**
 * Global list of checkers which are assigned to different multichoice fields
 */
const mCheckers = {
    "git": function (choice) {
...
/**
 * Run when the page has loaded, binds all the multichoices to the class and assigns a checker
 */
